...
@interface AppController : NSObject 
{
	...
	NSMutableArray * _voltageValues;
	NSMutableArray * _dummyTimes;
    IBOutlet NSTextView *voltageHistory;
    IBOutlet NSTextField *voltageLabel;
    
    IBOutlet NSTextField *triggerVoltageField;
    IBOutlet NSTextField *triggerTimeField;
    IBOutlet NSTextField *downCommandField;
    IBOutlet NSTextField *upCommandField;
}
